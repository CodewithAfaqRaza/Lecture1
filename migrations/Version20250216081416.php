 ...
 */
final class Version20250216081416 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE job_application (id INT AUTO_INCREMENT NOT NULL, job_id INT NOT NULL, candidate_id INT NOT NULL, cover_latter VARCHAR(255) NOT NULL, INDEX IDX_C737C688BE04EA9 (job_id), INDEX IDX_C737C68891BD8781 (candidate_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
